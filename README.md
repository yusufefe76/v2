...
The project will utilize **three** primary datasets to ensure a robust analysis:

### 1. *Agricultural Production Dataset (Yield Statistics)*
- **Source:** [TÜİK Data Portal](https://data.tuik.gov.tr/)
...
- **Source:** [MGM Official Statistics](https://www.mgm.gov.tr/veridegerlendirme/il-ve-ilceler-istatistik.aspx)
...
- **Coverage:** Number of tractors per province. This serves as a reliable proxy for agricultural intensity and technological adaptation.
- **Temporal Range:** 2005 – 2024
- **Variables:**
  - **Number of Tractors**
  - Province
...
2. **Statistical Analysis**
   ...
   - Build multiple linear regression models to isolate variables:
     $$Yield = \beta_0 + \beta_1(Temperature) + \beta_2(Rainfall) + \beta_3(Tractors) + \epsilon$$
